...
namespace Sensor_Aware_PT
{
    ...
    public partial class Form_3Dcuboid : Form
    {
        ...
        /// <summary>
        /// Vector to hold the orientation.
        /// </summary>
        ...
        public Vector3 Orientation
        {
            ...
            set
            {
                ...
                transformationMatrix[ 4 ] = res.M12;
                transformationMatrix[ 8 ] = res.M13;
                transformationMatrix[ 1 ] = res.M21;
                transformationMatrix[ 5 ] = res.M22;
                transformationMatrix[ 9 ] = res.M23;
                transformationMatrix[ 2 ] = res.M31;
                transformationMatrix[ 6 ] = res.M32;
                transformationMatrix[ 10 ] = res.M33;
