...
#define ACCEL_X_MAX ((float) 278)
#define ACCEL_Y_MIN ((float) -296)
#define ACCEL_Y_MAX ((float) 292)
#define ACCEL_Z_MIN ((float) -324)
#define ACCEL_Z_MAX ((float) 262)

// Magnetometer
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -228)
#define MAGN_X_MAX ((float) 382)
#define MAGN_Y_MIN ((float) -264)
#define MAGN_Y_MAX ((float) 344)
#define MAGN_Z_MIN ((float) -305)
#define MAGN_Z_MAX ((float) 270)

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) 18.96)
#define GYRO_AVERAGE_OFFSET_Y ((float) -7.18)
#define GYRO_AVERAGE_OFFSET_Z ((float) -14.59)
